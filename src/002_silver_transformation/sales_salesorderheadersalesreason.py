...
source_table = "sales_salesorderheadersalesreason"
...
target_table_name = "sales_salesorderheadersalesreason"
...
# MAGIC %sql 
# MAGIC select * from adventure_works_prata.sales_salesorderheadersalesreason limit 10

# COMMAND ----------

# MAGIC %sql 
# MAGIC select count(*) from adventure_works_prata.sales_salesorderheadersalesreason