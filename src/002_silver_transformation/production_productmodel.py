...
# MAGIC %sql 
# MAGIC select * from hive_metastore.adventure_works_prata.production_productmodel limit 10

# COMMAND ----------

# MAGIC %sql 
# MAGIC select count(*) from hive_metastore.adventure_works_prata.production_productmodel