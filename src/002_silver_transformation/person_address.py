...
# MAGIC %sql 
# MAGIC select * from hive_metastore.adventure_works_prata.person_address limit 10

# COMMAND ----------

# MAGIC %sql 
# MAGIC select count(*) from hive_metastore.adventure_works_prata.person_address